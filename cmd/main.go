...
import (
	...
	"github.com/oleksiyp/derived-secret-operator/internal/controller"
...
func main() {
	...
	// Default operator namespace if not provided
	if operatorNamespace == "" {
		operatorNamespace = "derived-secret-operator-system"
	}
	...
	//
	// For production with cert-manager, enable:
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4eec1838.oleksiyp.dev",
	...
	if err := (&controller.MasterPasswordReconciler{
		Client:            mgr.GetClient(),
		Scheme:            mgr.GetScheme(),
		OperatorNamespace: operatorNamespace,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MasterPassword")
		os.Exit(1)
	}
